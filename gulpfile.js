...
gulp.task('gulp_nodemon', function() {
  nodemon({
    ...
    ext: 'js', //nodemon watches *.js, *.html and *.css files
...
gulp.task('sync', function() {
  ...
  gulp.watch(['./**/*.js', './**/*.html', './**/*.css', './**/*.ejs']).on("change", browserSync.reload);
});

gulp.task('default', gulp.series(gulp.parallel('gulp_nodemon', 'sync')));